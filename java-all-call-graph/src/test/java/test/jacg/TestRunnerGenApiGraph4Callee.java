...
import com.adrninistrator.jacg.runner.RunnerGenApiGraph4Callee;
...
public class TestRunnerGenApiGraph4Callee {
    ...
    public void getAllGraph4Callee(){
        RunnerGenApiGraph4Callee runnerGenAllGraph4Callee = new RunnerGenApiGraph4Callee();
