...
public class JSON {
    ...
    public static <T> T deepCopy(Object src, Class<T> toValueType){
        return objectMapper.convertValue(src, toValueType);
    }

    public static <T> T deepCopy(Object src, TypeReference<T> typeReference){
        return objectMapper.convertValue(src,typeReference);
    }
}
