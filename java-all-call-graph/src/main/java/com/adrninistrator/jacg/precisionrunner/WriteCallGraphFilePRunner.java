...
import com.adrninistrator.jacg.precisionrunner.base.AbstractPRunner;
 ...
 * 生成Java方法调用关系文件
 */
public class WriteCallGraphFilePRunner extends AbstractPRunner {
    private static final Logger logger = LoggerFactory.getLogger(WriteCallGraphFilePRunner.class);
